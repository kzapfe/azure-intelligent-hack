...
- Open a terminal go to the root of your repository: azure-intelligent-hack, then write: `chmod 700 azureconfig.sh`, this allow us to run the script.
...
+ Open the Azure Functions project with Visual Studio 2017 then compile and publish to Azure.
  1.  Ensure you have the latest version of the following extensions: Azure Functions and Web Jobs Tools.
